...
class DeleteDataFieldsWidget extends StatefulWidget {
  final String? userId;
  final String? userName;
  const DeleteDataFieldsWidget(
      {super.key, required this.userId, required this.userName});

  @override
  State<DeleteDataFieldsWidget> createState() => _DeleteDataFieldsWidgetState();
}

class _DeleteDataFieldsWidgetState extends State<DeleteDataFieldsWidget> {
  final scaffoldKey = GlobalKey<ScaffoldState>();
  String? _dataType = "Select Data Type";
  String? _loss = "Select Loss";
  List<String> lossValues = ["Select Loss"];
  String? _valueToDelete = "Select Value To Delete";
  List<String> deleteValueList = ["Select Value To Delete"];
  Future<void> getDropDownData(String? dataType) async {
    deleteValueList = ["Select Value To Delete"];
    print("===========================");
    DatabaseHelper databaseHelper = DatabaseHelper.instance;
    List<Map<String, dynamic>> deleteDropdownValues =
        await databaseHelper.getDropdownValuesByType(dataType!);
  ...
  Future<void> getDropDownDataSubLoss(String? loss) async {
    deleteValueList = ["Select Value To Delete"];
    print("===========================");
    DatabaseHelper databaseHelper = DatabaseHelper.instance;
    List<String> deleteDropdownValues =
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Text(
                        'Delete Data From DropDown Fields',
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: DropdownButton<String>(
                            value: _loss,
                            onChanged: (value) async {
                              await getDropDownDataSubLoss(value);
                              setState(() {
                                _loss = value;
                              });
                            },
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: DropdownButton<String>(
                          value: _valueToDelete,
                          onChanged: (value) {
                            setState(() {
                              _valueToDelete = value;
                            });
                          },
                          dropdownColor: const Color(0xFFA5CF53),
                          items: deleteValueList.map((String value) {
                            return DropdownMenuItem<String>(
                              value: value,
                              child: Padding(
                                padding: const EdgeInsets.fromLTRB(8, 0, 8, 0),
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          if (_dataType == "Select Data Type" ||
                              _valueToDelete == "Select Value To Delete") {
                          ...
                          try {
                            ...
                            List<Map<String, String>> valuesToAdd = [
                              {
                                'dropdownType': _dataType!,
                                'value': _valueToDelete!
                              },
                            ];
                            print("========================================");
                            print("Deleting following value ${valuesToAdd}");
                            if (_dataType == "Sub Loss") {
                              await databaseHelper.deleteSubLoss(
                                  _loss!, _valueToDelete!);
                            } else {
                              await databaseHelper.deleteDropdownValue(
                                  _dataType!, _valueToDelete!);
                            }

                            ElegantNotification.success(
                              title: const Text("Success"),
                              description: const Text("Value Deleted"),
                            ...
                            ElegantNotification.success(
                              ...
                              description:
                                  const Text("Value could not be deleted"),
                              width: MediaQuery.of(context).size.width - 30,
                              toastDuration: const Duration(seconds: 5),
                            ).show(context);
                          }
