...
class DownloadDateSelectorWidget extends StatefulWidget {
  const DownloadDateSelectorWidget({super.key});

  @override
  State<DownloadDateSelectorWidget> createState() =>
      _SelectDateRouteWidgetState();
}

class _SelectDateRouteWidgetState extends State<DownloadDateSelectorWidget> {
                            ...
                            try {
                              ...
                              ElegantNotification.success(
                                ...
                                description: const Text(
                                    "Excel Sheet Downloaded in Downloads Folder"),
                              ...
                              ElegantNotification.error(
                                ...
                                description:
                                    const Text("Could Not Download Excel"),
                                width: 300,
                              ).show(context);
                            }
